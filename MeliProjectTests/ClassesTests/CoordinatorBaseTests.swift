...
@testable import class MeliProject.CoordinatorBase
@testable import class MeliProject.GenericCoordinatorBase
...
class CoordinatorBaseTests: XCTestCase, TestBase {
    ...
    func testPushCoordinatorSetsTheCorrectParent() {
        ...
        XCTAssertEqual(sut.childCoordinators.first!.parentCoordinator, sut)
    }
